...
class LlamaCppLLM:
    ...
    def generate(
        ...
        *,
        ...
        ctx_size = int(os.environ.get("IEP_CTX_SIZE", "12288") or "12288")
        threads = int(os.environ.get("IEP_THREADS", "8") or "8")
        ubatch = int(os.environ.get("IEP_UBATCH", "512") or "512")
        raw_reasoning_budget = int(os.environ.get("IEP_REASONING_BUDGET", "0") or "0")
        # Current llama.cpp accepts only:
        # -1 (unrestricted thinking) or 0 (disabled).
        reasoning_budget = -1 if raw_reasoning_budget > 0 else 0
